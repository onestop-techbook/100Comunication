...
//embed{
    ...
    \hspace{1ex}
//}
締め切りが…。ああ、窓に！窓に！（だいたいいつも、締切でSAN値がピンチ）
...
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
        \includegraphics[width=.75\linewidth]{images/contributors/onishi_feuer_400x400.jpg}
    \end{minipage}
    \begin{minipage}{.89\linewidth}
...
//embed{
    ...
    \end{minipage}
    \begin{minipage}{.89\linewidth}
        鬼無里 餅衛門 @kinasato\_mochi https://twitter.com/kinasato\_mochi\\
        \end{minipage}
    \hspace{1ex}
//}
