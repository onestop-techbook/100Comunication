...
Slack であればおそらく#randomという雑談用チャンネルがあるはずです。もし社員数が多すぎて#randomで雑談をする勇気が持てない場合、もう少し小さい単位で雑談できるチャンネルがあってもいいでしょう。たとえば #tech_random というエンジニアのための雑談チャンネルであったり #team10_random というようなチームごとの雑談チャンネルです。
