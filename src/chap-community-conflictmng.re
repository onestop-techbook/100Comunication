...
ふーれむというものです。
本章に関係ある範囲で簡単に自己紹介させて頂くと、前職はSIerで受諾開発をもりもりやっておりました。（現職は業務システム内製型の社内SEです。）

前職で、とある先輩に「ふーれむ君はどうもコンフリクトが起きがちなので、
コンフリクト・マネジメントについて調べてみたらいいんじゃない？」とアドバイスをもらったことがあり、
そのときにそんな用語があるのか…という知見を得たのですが、その後そういう方向で頭を打つ前に
転職しちゃった関係であまり深堀りする機会がなかったのですが、ちょうど今回執筆の機会を得まして、
そういえばこんなネタあったな…と思って色々調べつつ、知見に関してアウトプットしてみる事にしました。

== いわゆるコンフリクトとは

https://mba.globis.ac.jp/about_mba/glossary/detail-11812.html

には、「コンフリクトとは、相反する意見、態度、要求などが存在し、互いに譲らずに緊張状態が生じること。対立、軋轢。」
と記載があります。

実例がわからないとイメージが湧きづらいですね。具体的な例で見てみましょう。
...
私が具体的に過去に経験してきたケースを次に例示してみましょう。
...
実際の現場などでも、開発現場はアムダールの法則などもあるため、コスト（人員）を増やして対応する場合、対応コスト以上に
