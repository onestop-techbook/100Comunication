...
リモートワーク環境を整えきる必要があるね。」という話になりました。この時点で厳密なデッドラインは見えていませんが、「なるはや」で対応する必要がある事は確定です。
（当然、ついていけない人が残ってしまうような状況になると厳しいです。）
...
この導入手順をある程度組んだ上で、まずは最優先でマニュアルを作成しました。（GUIの動きベースで明記し、丁寧に記載）
...
※　英語に関してはほぼほぼBASICの構文に寄せて話をしました。　多分伝わるやろて・・・　と思ってやってましたが、結果としてうまくいったので多分伝わってるはず！
