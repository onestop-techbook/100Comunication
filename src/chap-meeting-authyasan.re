...
そして、このドキュメント読むことで、読者の会議時間は15分程度になるだろう※。
...
さっきググったところ、一般的な会議は約70分らしい。すなわち、一回あたり平均40分の時間が浮くことになる。
月に開催される会議の回数を仮に3回としよう。
さらに読者が定年するまでに40年(※)あると仮定する。
...
※ この記事にそうかいてあった https://www.jrta.co.jp/research/person_vol14.pdf
※ あなたの定年は75歳〜80歳だろう。
...
定例報告に代表される1番目の「情報を共有する会議」は対象ではない。※
...
※ そもそもこれだけITツールが発達した中で情報共有するためだけに会議を開く必要があるのか？という話もあるが、それについて論じるのはまたべつの機会にしよう
